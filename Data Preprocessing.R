...
traffic = read.csv(file.choose(), header = T)
broad = read.csv(file.choose(), header = T)
>>>>>>> 650259bf7046444f8e76c9e89d84f2fca98ae541
...
trafAmountBel = as.matrix(table(traffic_bel$date)) #how much traffic per day

#amount of traffic per day -- Total
#NOTE: you can only run this after running both Net and Bel
